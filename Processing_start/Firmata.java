...
//    }
  ...
  public void setRGBLCD(int r, int g, int b) {
    out.write(START_SYSEX);
    out.write(0x51);
    out.write(5); // argv[1]
    out.write(r);
  ...
  public void setPositionLCD(int line, int pos) {
    int thepos = 128; // line 1
    if(line > 1) thepos = 192; // line 2
  ...
  public void printLCD(String thestring) {
    out.write(START_SYSEX);
    out.write(0x51);
    out.write(3); // argv[0]
    
    // always send 16 chars string
    String str = padString(thestring, 16);

    char[] med = str.toCharArray();
